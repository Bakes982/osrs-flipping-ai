...
def test_predictor_global_no_model_cache_skips_new_instance_load(monkeypatch):
    from backend.ml import predictor as predictor_module

    predictor_module.Predictor._GLOBAL_MODELS_CHECKED = True
    predictor_module.Predictor._GLOBAL_MODELS_AVAILABLE = False
