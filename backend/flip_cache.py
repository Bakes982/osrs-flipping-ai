...
def _emit_dump_alert(metrics: dict) -> None:
    """Phase 4: suppress direct candidate sends; accepted dump trades notify positions channel."""
    logger.info("DUMP_CANDIDATE_SUPPRESSED item_id=%s", metrics.get("item_id"))
    return
